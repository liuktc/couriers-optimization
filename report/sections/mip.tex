...
\begin{figure}[!h]
    ...
    \subfloat[Execution Time]{
        \includegraphics[width=0.3\textwidth]{execution_time_2.png}
    }
    \hfill
    \subfloat[Simplex Iterations]{
        \includegraphics[width=0.3\textwidth]{simplex_iterations_2.png}
    }
    \hfill
    \subfloat[Branching nodes]{
