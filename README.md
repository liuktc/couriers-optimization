...
| $2$ | $\color{green}\text{0 s (obj: 226)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{2 s (obj: 226)}$</br>$\color{green}\text{plain}$ | $\color{red}\text{Inconsistent}$ | 
| $3$ | $\color{green}\text{0 s (obj: 12)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{1 s (obj: 12)}$</br>$\color{green}\text{twosolver}$ | $\color{red}\text{Inconsistent}$ | 
| $4$ | $\color{green}\text{0 s (obj: 220)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{2 s (obj: 220)}$</br>$\color{green}\text{plain-symm}$ | $\color{red}\text{Inconsistent}$ | 
...
| $9$ | $\color{green}\text{0 s (obj: 436)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{2 s (obj: 436)}$</br>$\color{green}\text{plain}$ | $\color{red}\text{Inconsistent}$ | 
| $10$ | $\color{green}\text{0 s (obj: 244)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{4 s (obj: 244)}$</br>$\color{green}\text{plain-symm}$ | $\color{red}\text{Inconsistent}$ | 
...
| $13$ | $\color{orange}\text{300 s (obj: 686)}$</br>$\color{orange}\text{vrp-gecode-lns-symm-strong}$ | $\color{red}\text{Inconsistent}$ | $\color{orange}\text{300 s (obj: 1504)}$</br>$\color{orange}\text{twosolver}$ | $\color{red}\text{Inconsistent}$ | 
