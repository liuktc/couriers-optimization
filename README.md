...
| $7$ | $\color{green}\text{0 s (obj: 167)}$</br>$\color{green}\text{vrp-lns80-gecode}$ | $\color{red}\text{Inconsistent}$ | $\color{red}\text{Inconsistent}$ | $\color{red}\text{Inconsistent}$ | 
...
| $18$ | $\color{orange}\text{300 s (obj: 662)}$</br>$\color{orange}\text{vrp-lns95-gecode}$ | $\color{red}\text{Inconsistent}$ | $\color{red}\text{Inconsistent}$ | $\color{red}\text{Inconsistent}$ | 
| $19$ | $\color{green}\text{41 s (obj: 334)}$</br>$\color{green}\text{vrp-lns90-gecode}$ | $\color{red}\text{Inconsistent}$ | $\color{red}\text{Inconsistent}$ | $\color{red}\text{Inconsistent}$ | 
