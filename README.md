...
| $4$ | $\color{green}\text{0 s (obj: 220)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{37 s (obj: 220)}$</br>$\color{green}\text{smt-first}$ | $\color{red}\text{Inconsistent}$ | 
...
| $9$ | $\color{green}\text{0 s (obj: 436)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{199 s (obj: 436)}$</br>$\color{green}\text{smt-first}$ | $\color{red}\text{Inconsistent}$ | 
| $10$ | $\color{green}\text{0 s (obj: 244)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{54 s (obj: 244)}$</br>$\color{green}\text{smt-first}$ | $\color{red}\text{Inconsistent}$ | 
