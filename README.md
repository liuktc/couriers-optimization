...
| $13$ | $\color{orange}\text{300 s (obj: 686)}$</br>$\color{orange}\text{vrp-gecode-lns-symm-strong}$ | $\color{red}\text{Inconsistent}$ | $\color{lightgray}\text{Timeout}$ | $\color{red}\text{Inconsistent}$ | 
