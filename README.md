...
| $2$ | $\color{green}\text{0 s (obj: 226)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{3 s (obj: 226)}$</br>$\color{green}\text{smt2-plain-linear-z3}$ | $\color{red}\text{Inconsistent}$ | 
...
| $7$ | $\color{green}\text{0 s (obj: 167)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{orange}\text{300 s (obj: 210)}$</br>$\color{orange}\text{smt2-plain-linear-cvc5}$ | $\color{red}\text{Inconsistent}$ | 
