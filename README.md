...
| $2$ | $\color{green}\text{0 s (obj: 226)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{green}\text{1 s (obj: 226)}$</br>$\color{green}\text{smt2-plain-linear-yices2}$ | $\color{red}\text{Inconsistent}$ | 
...
| $13$ | $\color{orange}\text{300 s (obj: 686)}$</br>$\color{orange}\text{vrp-gecode-lns-symm-strong}$ | $\color{red}\text{Inconsistent}$ | $\color{orange}\text{300 s (obj: 1446)}$</br>$\color{orange}\text{smt2-plain-linear-z3}$ | $\color{red}\text{Inconsistent}$ | 
...
| $16$ | $\color{green}\text{11 s (obj: 286)}$</br>$\color{green}\text{vrp-gecode-lns}$ | $\color{red}\text{Inconsistent}$ | $\color{orange}\text{300 s (obj: 1032)}$</br>$\color{orange}\text{smt2-plain-linear-yices2}$ | $\color{red}\text{Inconsistent}$ | 
